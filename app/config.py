...
class Settings(BaseSettings):
    ...
    docker_wordpress_image: str = Field(default="wordpress:7.1-php8.3-fpm-alpine", validation_alias="DOCKER_WORDPRESS_IMAGE")
    docker_wordpress_container: str = Field(default="triforce-wordpress", validation_alias="DOCKER_WORDPRESS_CONTAINER")
    docker_wordpress_db_image: str = Field(default="mariadb:11.8", validation_alias="DOCKER_WORDPRESS_DB_IMAGE")
    ...
    docker_flarum_image: str = Field(default="mondedie/flarum@sha256:adbf9c31c7c3eacea79b0265df0f53b5a278a14c15a81ca0f35c7ded2ebc4fd8", validation_alias="DOCKER_FLARUM_IMAGE")
    docker_flarum_container: str = Field(default="triforce-flarum", validation_alias="DOCKER_FLARUM_CONTAINER")
    docker_flarum_db_image: str = Field(default="mariadb:11.8", validation_alias="DOCKER_FLARUM_DB_IMAGE")
    ...
    docker_searxng_image: str = Field(default="searxng/searxng@sha256:892cf809341915a4b7710d3c9045005b4c377d51335a089b6d4da0b28750788d", validation_alias="DOCKER_SEARXNG_IMAGE")
    ...
    docker_n8n_image: str = Field(default="n8nio/n8n:2.34.6", validation_alias="DOCKER_N8N_IMAGE")
    ...
    docker_mailserver_image: str = Field(default="ghcr.io/docker-mailserver/docker-mailserver:16.0.1", validation_alias="DOCKER_MAILSERVER_IMAGE")
