...
AIHELPER_PAIR_TOOL = {
    'name': 'aihelper_pair',
    'description': 'Manage the current AILinux Helper share/workspace binding. Use action=status to inspect it, pair with a one-time code, reconnect a durable lease, or disconnect/revoke it when the user explicitly asks.',
    'inputSchema': {
        'type': 'object',
        'properties': {
