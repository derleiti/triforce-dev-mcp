...
public class MainActivity extends Activity {
    ...
    private final BroadcastReceiver receiver=new BroadcastReceiver(){@Override public void onReceive(Context c,Intent i){String s=i.getStringExtra("state");if(s!=null)status.setText(s);String code=i.getStringExtra("pair_code");if(code!=null&&!code.isEmpty()){pair.setText(code);pair.setSelection(code.length());}}};
