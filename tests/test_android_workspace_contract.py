...
def test_native_executor_uses_existing_workspace_protocol():
    ...
    for token in ['/v1/mcp/node/connect','workspace/share','client_workspace_tool','workspace/tool_stage','/v1/mcp/workspace/resume-ticket','handoff_code','2.86.6-android']:
